...
@Autonomous(name="tehehe", group="Hanga")
public class tehehe extends LinearOpMode {
    //
    DcMotorEx frontleft;
    ...
    Double bias = 0.315;//default 0.8
    Double meccyBias = 0.38;//change to adjust only strafing movement
    //
