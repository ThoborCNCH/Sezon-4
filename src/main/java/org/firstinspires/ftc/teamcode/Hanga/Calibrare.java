...
@Config
@Disabled
@Autonomous(name="Calibrate", group="Hanga")
public class Calibrare extends LinearOpMode {
    ...
    Double cpr = 146.6; //counts per rotation
    Double gearratio = 5.2;
    Double diameter = 4.0;
    Double cpi = (cpr * gearratio) / (Math.PI * diameter); //counts per inch -> counts per rotation / circumference
    public static double bias = 0.315;//adjust until your robot goes 20 inches
    //
