...
import static org.firstinspires.ftc.teamcode.HackGoogle.NuUmbla.LA_B_Alb_ST_DR;
import static org.firstinspires.ftc.teamcode.HackGoogle.NuUmbla.LA_C_Alb_ST_DR;
import static org.firstinspires.ftc.teamcode.HackGoogle.NuUmbla.startposAlbastruDreaptaCelalalt;
...
@Autonomous(name = "AlbastruDreaptaDreapta", group = "nationala")
public class BileteNolan extends LinearOpMode {
...
//                tfod.setClippingMargins(left, top, right, bottom);
        ...
        robot.setPoseEstimate(startposAlbastruDreaptaCelalalt);
        ...
        if (opModeIsActive()) {
            while (opModeIsActive()) {
                ...
                if (path == 1) {
                    Trajectory du_te_sa_scuipi_a = robot.trajectoryBuilder(startposAlbastruDreaptaCelalalt)
                            .splineToLinearHeading(new Pose2d(-15, 20, Math.toRadians(9)), Math.toRadians(-15),
                    ...
                    Trajectory laA = robot.trajectoryBuilder(du_te_sa_scuipi_a.end())
                            .splineToLinearHeading(new Pose2d(10, 42.00, Math.toRadians(-90)), Math.toRadians(10),
                ...
                if (path == 2) {
                    Trajectory du_te_sa_scuipi_b = robot.trajectoryBuilder(startposAlbastruDreaptaCelalalt)
                            .splineToLinearHeading(new Pose2d(-15, 20, Math.toRadians(9)), Math.toRadians(40),
                                    SampleMecanumDrive.getVelocityConstraint(20, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                                    SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                            .build();
                    ...
                    Trajectory laB = robot.trajectoryBuilder(du_te_sa_scuipi_b.end())
                            .lineToLinearHeading(LA_B_Alb_ST_DR,
                                    SampleMecanumDrive.getVelocityConstraint(50, 4, DriveConstants.TRACK_WIDTH),
                                    SampleMecanumDrive.getAccelerationConstraint(30))
                            .build();
                ...
                if (path == 3) {
                    Trajectory du_te_sa_scuipi_c = robot.trajectoryBuilder(startposAlbastruDreaptaCelalalt)
                            .splineToLinearHeading(new Pose2d(-15, 20, Math.toRadians(7)), Math.toRadians(40),
                                    SampleMecanumDrive.getVelocityConstraint(20, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                                    SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                            .build();
                    ...
                    Trajectory laC = robot.trajectoryBuilder(du_te_sa_scuipi_c.end())
                            .splineToLinearHeading(LA_C_Alb_ST_DR, Math.toRadians(30),
                                    SampleMecanumDrive.getVelocityConstraint(50, 4, DriveConstants.TRACK_WIDTH),
                                    SampleMecanumDrive.getAccelerationConstraint(30))
                            .build();
                    ...
                    Trajectory park = robot.trajectoryBuilder(laC.end())
                            .splineToLinearHeading(new Pose2d(5, 17, Math.toRadians(-5)), Math.toRadians(30),
                                    SampleMecanumDrive.getVelocityConstraint(50, 4, DriveConstants.TRACK_WIDTH),
                                    SampleMecanumDrive.getAccelerationConstraint(30))
                            .build();
