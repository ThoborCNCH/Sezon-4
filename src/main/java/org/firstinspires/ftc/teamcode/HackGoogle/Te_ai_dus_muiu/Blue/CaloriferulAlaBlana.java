...
import static org.firstinspires.ftc.teamcode.HackGoogle.NuUmbla.startposAlbastruStanga;
...
@Autonomous(name = "AlbastruStangaDreapta", group = "nationala")
public class CaloriferulAlaBlana extends LinearOpMode {
...
//                tfod.setClippingMargins(left, top, right, bottom);
        ...
        robot.setPoseEstimate(startposAlbastruStanga);
        ...
        if (opModeIsActive()) {
            while (opModeIsActive()) {
                ...
                if (path == 1) {
                    Trajectory du_te_sa_scuipi_a = robot.trajectoryBuilder(startposAlbastruStanga)
                            .splineToLinearHeading(new Pose2d(-15, 60, Math.toRadians(0)), Math.toRadians(-15),
                    ...
                    Trajectory laA = robot.trajectoryBuilder(du_te_sa_scuipi_a.end())
                            .lineToLinearHeading(new Pose2d(-7, 65, Math.toRadians(-170)),
                ...
                if (path == 2) {
                    Trajectory du_te_sa_scuipi_b = robot.trajectoryBuilder(startposAlbastruStanga)
                            .splineToLinearHeading(new Pose2d(-15, 60, Math.toRadians(0)), Math.toRadians(-15),
                                    SampleMecanumDrive.getVelocityConstraint(20, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                                    SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                            .build();
                ...
                if (path == 3) {
                    Trajectory du_te_sa_scuipi_c = robot.trajectoryBuilder(startposAlbastruStanga)
                            .splineToLinearHeading(new Pose2d(-15, 60, Math.toRadians(-3)), Math.toRadians(-15),
                                    SampleMecanumDrive.getVelocityConstraint(20, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                                    SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                            .build();
                    ...
                    Trajectory laC = robot.trajectoryBuilder(du_te_sa_scuipi_c.end())
                            .lineToLinearHeading(new Pose2d(38, 65, Math.toRadians(-170)),
                                    SampleMecanumDrive.getVelocityConstraint(50, 4, DriveConstants.TRACK_WIDTH),
                                    SampleMecanumDrive.getAccelerationConstraint(30))
                            .build();
